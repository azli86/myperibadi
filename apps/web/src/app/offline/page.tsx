      ...
      <div className="w-full max-w-2xl relative z-10">
        <div className="bg-[var(--card)]/85 backdrop-blur-2xl border border-[var(--border)] rounded-2xl shadow-2xl p-8 md:p-10">
          <div className="flex flex-col items-center text-center">
            {/* Icon */}
            <div className="h-18 w-18 md:h-20 md:w-20 rounded-2xl flex items-center justify-center shadow-xl mb-6 bg-amber-500/10 text-amber-500 shadow-amber-500/10">
              <WifiOff size={36} />
            </div>
