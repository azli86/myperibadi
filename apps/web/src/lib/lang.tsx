...
export const translations = {
  EN: {
    ...
    verifyEmailInvalid: "The link is invalid or expired. Please log in to MyPeribadi and tap ‘Resend verification email’ to get a fresh link.",
  ...
  BM: {
    ...
    verifyEmailInvalid: "Pautan tidak sah atau telah tamat tempoh. Sila log masuk ke MyPeribadi dan tekan ‘Hantar semula e-mel pengesahan’ untuk pautan baharu.",
